...
class info(commands.Cog):
    ...
    async def _server(self, ctx):    
        ...
        embed.add_field(name=f"Пользователей", value=f"Закрыто: **{users}**\n"
                                                     f"Закрыто: **{bots}**\n"
                                                     f"Закрыто: **{online}**\n"
                                                     f"Закрыто: **{idle}**\n"
                                                     f"Не Беспокоить: **{dnd}**\n"
        ...
        embed.add_field(name=f"Закрыто", value=f"{ctx.guild.owner}")
...
:wave: Привет! Меня зовут FygaFell!

:sunglasses: Мой префикс: 'd.'
:rofl: Я был создан чтобы поднять тебе настроение!
:astonished: Напиши команду d.команды чтобы узнать все мои возможности!
:wink: Можно настроить сервер через меня, просто пропиши d.настройки(БЕТА-ТЕСТ)
:thinking: Нужна помощь по боту, или нашел баг/ошибку? Заходи на наш [сервер поддержки] https://discord.gg/x2VkySxW9y !


:four_leaf_clover: Будьте крутыми как Фелл, Кнеффи и Тоффи!
